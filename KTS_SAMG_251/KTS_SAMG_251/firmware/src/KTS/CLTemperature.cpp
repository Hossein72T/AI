...
{
	gRDEeprom.hister_Temp_Hot[ limitType ]	= (char) (value * 10.0f);
}
...
{
	gRDEeprom.hister_Temp_Cold[ limitType ]	= (char) (value * 10.0f);
}
...
{
	gRDEeprom.hister_AWP_Temp_Hot[ limitType ]	= (char) (value * 10.0f);
}
...
{
	gRDEeprom.hister_AWP_Temp_Cold[ limitType ]	= (char) (value * 10.0f);
}
